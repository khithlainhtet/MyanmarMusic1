...
#BOT FILE NAME
from MyanmarMusic import app as app
from MyanmarMusic.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="🐼 ᴅᴇᴠᴇʟᴏᴘᴇʀ  🥀",
            url=f"https://t.me/HANTHAR999",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "MyanmarMusic/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "MyanmarMusic/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("MyanmarMusic/assets/cppicbranded.jpg")
