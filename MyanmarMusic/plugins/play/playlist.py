...
from MyanmarMusic import Carbon, app
from MyanmarMusic.utils.decorators.language import language, languageCB
from MyanmarMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
from MyanmarMusic.utils.pastebin import HottyBin
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from MyanmarMusic import YouTube
